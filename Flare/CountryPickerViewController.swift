...
class CountryPickerViewController: UIViewController, UIPickerViewDataSource, UIPickerViewDelegate {
    ...
    override func prepareForSegue(segue: UIStoryboardSegue, sender: AnyObject?) {
        if let destination = segue.destinationViewController as? VerifyPhoneViewController {
    ...
    func loadCountries() {
        ...
        let sortedDict = countriesDictionary.sort {
            return $0.0.0 < $0.1.0
        }
        countriesArray = sortedDict
    }
}
